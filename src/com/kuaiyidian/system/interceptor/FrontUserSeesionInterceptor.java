package com.kuaiyidian.system.interceptor;
...
public class FrontUserSeesionInterceptor implements Interceptor {
	public static Log log = LogFactory.getLog(FrontUserSeesionInterceptor.class);
	...
	private String _intercept(ActionInvocation invocation) throws Exception {
		...
		if (null == user) {
			...
			ActionContext.getContext().put("afterLoginUrl", des.encrypt(uri));
