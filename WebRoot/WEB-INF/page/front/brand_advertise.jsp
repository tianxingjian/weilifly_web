...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var thePlayer;
			$(function(){
				 videoInit("${advertiseList[0].path}","${advertiseList[0].image}");
			     ...
			     $(".video-pic").click(function(){
			     	...
			     	$.shovePost("brandAdvertise.do",param,function(data){
						var path = data.path;
		...
		<div class="content">
			<div class="main-content">
				...
				<div class="kyd-report">
					...
					<div class="play-info">
						<a href="${advertiseList[0].path}" class="down" id="path">下载</a>
						<div class="num" id="views">
							${advertiseList[0].views }次
						</div>
					...
					<!--<div class="video-item-box">
						<div class="video-item"
							style="padding-bottom: 20px; background: #f3f3f3;">
							<ul class="v-list">
								<s:iterator value="#request.advertiseList" var="bean" status="st">
									<li <s:if test="#st.index==0">class="cur"</s:if> >
										<a href="javascript:;" class="v-item" reportId="${bean.id}" ><img src="${bean.image }" width="180px" height="105px" /> </a>
										<div class="p-bg"></div>
										<div class="font">
											正在播放
										</div>
								...
								<tr>
									...
									<td>
										<div <s:if test="#st.index==0">class="contact_1 cur"</s:if> <s:else>class="contact_1"</s:else>>
											<a href="javascript:;" class="video-pic" reportId="${bean.id}" ><img src="${bean.image }" />
											</a>
											<div class="p-bg"></div>
											<div class="font">
												正在播放
