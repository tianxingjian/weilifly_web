			...
			<s:else>
				...
				<s:iterator value="pageBean.page" var="bean" status="st">
					<tr class="gvItem">
						...
						<td>
							<a
								href="updateQuestionInit.do?id=${bean.id }&pageNow=${pageBean.pageNum}"
								target="main"> 编辑</a>
							<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;"
								onclick="deleteQuestionById(${bean.id },${pageBean.pageNum})">删除</a>
						</td>
					</tr>
				</s:iterator>
			</s:else>
	...
	<tbody>
		<tr>
			<td class="blue12" style="padding-left: 8px" align="left">
				...
				全选 &nbsp;&nbsp;&nbsp;&nbsp;
				<input id="btnDel" onclick="deleteQuestions();" type="button"
