			...
			<s:else>
				<s:iterator value="pageBean.page" var="bean" status="st">
					<tr class="gvItem">
						...
						<td>
							<img alt="" src="../${bean.imgUrl}" height="80px"/>
						</td>
						<td>
							${bean.sortIndex }
						</td>
						...
						<td>
							<a
								href="updateImgListInit.do?id=${bean.id }&pageNow=${pageBean.pageNum}"
								target="main"> 编辑</a>
							<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;"
								onclick="deleteImgListById(${bean.id },${pageBean.pageNum})">删除</a>
						</td>
					</tr>
				</s:iterator>
			</s:else>
